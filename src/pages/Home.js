            ...
            <div className="home_body">
                <div className="home_body1">
                    ...
                    <div className="home_1_buttons">
                        <button onClick={()=>{window.location.href='/emotiontotal'}}className="home_buttons1_1"><Link className="home_button_link" to='/emotiontotal'>나른 스페이스 시작하기</Link></button>
                    </div>
                </div>
                <div className="home_body2">
                    <div className="home_body_title2">쌓인 감정은<br/>외로움을 만들어요.</div>
                    <img className="homeImage2"src={image2}></img>
                ...
                <div className="home_body2">
                    ...
                    <img className="homeImage3"src={image3}></img>
                ...
                <div className="home_body2">
                    ...
                    <img className="homeImage4"src={image4}></img>
