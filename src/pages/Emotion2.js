...
function Emotion2({user,setOpen,setIsAuth, isAuth}){//반복문 최소화 하기
    ...
    return(
        <div className="Emotion1">
            <div className="headerTab">
                ...
                <div><Link className="headerTabButton1" to='/emotion2'><img id="headerTabButtonImg100" src={pfp2}/><h3 id="headerTabButtonTxt1" className="subhead100">분노</h3></Link></div>
            ...
            <div className="posts">
                <HomeTitle user={user}setIsAuth={setIsAuth} isAuth = {isAuth} posts={"post2"} />
            </div>
        </div>
    )
