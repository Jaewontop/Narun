...
function Emotion4({user,setOpen,setIsAuth, isAuth}){
    ...
    return(
        <div className="Emotion1">
            <div className="headerTab">
                ...
                <div><Link className="headerTabButton1" to='/emotion4'><img id="headerTabButtonImg100" src={pfp4}/><h3 id="headerTabButtonTxt1" className="subhead100">사랑</h3></Link></div>
            ...
            <div className="posts">
                <HomeTitle user={user}setIsAuth={setIsAuth} isAuth = {isAuth} posts={"post4"} />
            </div>
        </div>
    )
}
