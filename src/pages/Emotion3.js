...
function Emotion3({setOpen,setIsAuth, isAuth}){
    ...
    return(
        <div className="Emotion1">
            <div className="headerTab">
                ...
                <div><Link className="headerTabButton" to='/emotion3'><img id="headerTabButtonImg100" src={pfp3}/><h3 id="headerTabButtonTxt1" className="subhead100">슬픔</h3></Link></div>
